# -*- coding: utf-8 -*-
# @Time    : 2025/6/25 16:06
# @Author  : Kai Kai
# @Site    : 
# @File    : ensembling_IFC.py
# @Software: PyCharm
...
params['init_lr'] = 10 ** -3
params['min_lr'] = 1e-9
params['weight_decay'] = 10 ** -4
params['lr_reduce_factor'] = 0.6
...
net_params['hidden_dim'] = 208
net_params['num_heads'] = 1
net_params['dropout'] = 0.598
net_params['depth'] = 3
net_params['layers'] = 3
...
for j in range(len(path_l)):
    for i in range(100):
        ...
        early_stopping = EarlyStopping(patience=params['earlystopping_patience'],
                                       path='checkpoint_ensemble' + params['Dataset'] + 'AIFC' + '.pt')
        with tqdm(range(params['max_epoch'])) as t:
            ...
            for epoch in t:
                ...
                epoch_test_loss, epoch_test_metrics = evaluate_frag(model, scaling, fetched_data.test_iter, fetched_data.test_batched_origin_graph_list,
                                                                        ...
                                                                        fetched_data.test_targets_list, fetched_data.test_smiles_list, fetched_data.test_names_list,
                                                                         n_param)
        ...
        _, epoch_raw_metrics = evaluate_frag(model, scaling, fetched_data.all_iter, fetched_data.all_batched_origin_graph_list,
                                                 ...
                                                 fetched_data.all_targets_list, fetched_data.all_smiles_list, fetched_data.all_names_list,
                                                  n_param)
